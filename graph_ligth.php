...
<html>
    ...
    <body>
        ...
        <center>
            <A href="draw.php"  onclick="click('')"><img src="draw.php?ImageMap=get&w=680&h=320&query_png=light&typeGraph=drawFilledStepChart" id="testPicture" alt="" class="pChartPicture"/>
        </center>
    </body>
</html>
